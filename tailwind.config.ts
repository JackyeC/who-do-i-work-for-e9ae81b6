...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        "elegant": "0 1px 3px 0 hsl(var(--foreground) / 0.04), 0 1px 2px -1px hsl(var(--foreground) / 0.04)",
        "elevated": "0 4px 12px -2px hsl(var(--foreground) / 0.08), 0 2px 4px -2px hsl(var(--foreground) / 0.04)",
        "prominent": "0 8px 24px -4px hsl(var(--foreground) / 0.1), 0 4px 8px -4px hsl(var(--foreground) / 0.06)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
