...
serve(async (req) => {
  ...
  try {
    ...
    const prompt = `Create a fun, colorful, cartoon-style corporate battle illustration featuring ONLY underrepresented people — Black women, Latina women, Indigenous women, women of color. On the left side, show a powerful woman of color warrior queen representing "${companyA}" (${industryA || "corporation"}) — she's fierce, confident, regal, in corporate armor with gold accessories. On the right side, show another powerful woman of color warrior queen representing "${companyB}" (${industryB || "corporation"}) — equally fierce and iconic. They face each other in an epic showdown arena with dramatic lightning between them. Style: bold colors, Afrofuturistic vibes, exaggerated expressions, humorous corporate satire. Include "VS" text in the center with electric effects. Make it fun, empowering, and shareable. Clean white background behind the arena. NO white men. Celebrate diversity and representation.`;
