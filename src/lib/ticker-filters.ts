...
export function isUSOrEmployerRelevant(
  ...
  const OFF_TOPIC_NOISE = /\b(premier league|champions league|bundesliga|serie a|la liga|uefa|fifa|nba |nfl |mlb |nhl |mls |f1 |wnba|mock draft|free agenc(y|ies)|trade rumor|angel reese|caitlin clark|draft pick|all[- ]star game|formula (one|1)|grand prix|world cup|cricket|rugby|tennis|golf tournament|boxing|mma|ufc|wrestling|olympic|playoffs?|semifinals?|transfer window|contract extension|hat[-\s]?trick|goal scor|match day|stadium|goalkeeper|striker|midfielder|defender|winger|coach fired|manager sacked|high[-\s]?end tv|displayport|oled tv|qled|soundbar|gaming console|playstation|xbox|nintendo|gpu benchmark|phone review|iphone \d|galaxy s\d|laptop review|headphone|earbuds?|smart home|roomba|air fryer|instant pot|recipe|cookbook|restaurant review|michelin star|fashion week|runway show|designer handbag|luxury brand|logo.?exhaustion|haute couture|red carpet|grammy|oscar|emmy|billboard chart|box office|movie review|film festival|tv show review|netflix original|celebrity|kardashian|royal family|prince harry|meghan markle|the boys|kripke|vought|real estate market|housing prices|mortgage rate|home renovation|interior design|pet care|dog breed|cat breed|travel destination|hotel review|cruise ship|vacation package|weather forecast|horoscope|astrology|crossword|lottery|genetic algorithm|markdown book|bayern munich|manchester united|manchester city|liverpool|chelsea|arsenal|tottenham|real madrid|barcelona|juventus|inter milan|psg|dortmund|napoli|atletico)(\b|[\s,.])/i;
