...
export const PERSONAS: PersonaConfig[] = [
  {
    ...
    secondarySections: ["governance", "influence"],
    hiddenSections: ["gtm"],
  ...
  },
  {
    ...
    secondarySections: ["career_risk", "values", "influence"],
  ...
  },
  {
    ...
    secondarySections: ["compensation", "workforce_stability"],
    hiddenSections: ["influence", "values"],
  ...
  },
  {
    ...
    hiddenSections: ["recruiter_reality", "gtm", "influence", "values"],
  ...
  },
  {
    ...
    primarySections: ["cbi", "workforce_stability", "governance", "influence", "compensation", "workforce_intel", "promotion_velocity", "gtm"],
    secondarySections: ["recruiter_reality", "values", "career_risk"],
    hiddenSections: [],
