...
export function OfferIntelligence({ salaryRange, leverageLevel, civicScore }: OfferIntelligenceProps) {
  ...
  return (
    <div className="p-4 rounded-lg border border-border/50 bg-muted/20">
      <p className="text-xs font-medium text-foreground uppercase tracking-wider mb-3 flex items-center gap-1">
        <DollarSign className="w-3 h-3 text-muted-foreground" /> Offer Intelligence
      </p>

      <div className="grid grid-cols-2 gap-3">
        <div>
          <p className="text-xs text-muted-foreground mb-0.5">Listed Range</p>
          {salaryRange ? (
        ...
        <div>
          <p className="text-xs text-muted-foreground mb-0.5">Negotiation Room</p>
