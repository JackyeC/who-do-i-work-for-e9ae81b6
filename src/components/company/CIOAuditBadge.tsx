...
export function CIOAuditBadge({ lastAuditedAt }: CIOAuditBadgeProps) {
  ...
  return (
    <Badge
      variant="outline"
      className="text-xs gap-1.5 font-semibold border-[hsl(var(--civic-gold))]/40 text-[hsl(var(--civic-gold))] bg-[hsl(var(--civic-gold))]/[0.06] shadow-[0_0_8px_hsl(var(--civic-gold)/0.15)]"
    >
