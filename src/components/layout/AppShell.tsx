 ...
 */
const MARKETING_PAGES = ["/about", "/how-it-works", "/for-employers", "/contact", "/pricing", "/submit-tip", "/newsletter", "/methodology", "/data-ethics", "/privacy", "/terms", "/values", "/community", "/would-you-work-here", "/policy", "/ask-jackye", "/check"];
