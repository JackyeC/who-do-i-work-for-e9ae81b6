...
const PRICING_TIERS = [
  {
    ...
    price: "$199",
    interval: "one-time",
    description: "Deep-dive dossier on one company — leadership, spending, stability, and everything public records reveal.",
    features: ["Complete signal breakdown", "Negotiation talking points", "Compensation benchmarks", "Downloadable PDF"],
    cta: "Get The Closer",
    highlighted: false,
  },
  {
    ...
    features: ["Full company dossiers — all signals", "Unlimited AI job-link audits", "Values alignment scoring", "Signal alerts"],
    cta: "Get The Signal",
    highlighted: true,
  },
  {
    ...
    price: "$149",
    interval: "/month",
    description: "Smart job matching. Auto-apply. Full career mapping. Priority alerts.",
    features: ["Smart job matching — jobs delivered to you", "Auto-apply queue", "Full career mapping + 5-year trajectory", "All Signal features"],
    cta: "Get The Match",
    highlighted: false,
  },
];
